...
import { LucideAngularModule, User, Save, X, ArrowLeft, Check } from 'lucide-angular';
...
export class ClienteFormComponent implements OnInit {
  ...
  private initForm(): void {
    this.form = this.fb.group({
      ...
      cpf: [
        '',
        [Validators.required, Validators.minLength(11), Validators.maxLength(14), cpfValidator()],
      ],
  ...
  onSubmit(): void {
    ...
    const formData = {
      ...this.form.value,
      cpf: sanitizeCpf(this.form.value.cpf),
  ...
  isCpfValid(): boolean {
    ...
    return control.valid && cleanCpf.length === 11;
  }
